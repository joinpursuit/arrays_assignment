 ...
 */
function removeLastandReturnLast(arr) {
  return arr.pop();
}
...
function largerArray(array1, array2) {
  ...
  let shorter = array1.length > array2.length ? array2 : array1;
...
function middleElement(array) {
 ...
 let array2 = [array[(array.length / 2) -1],  array[(array.length/2)]]
