...
addFruitToEnd(['apple', 'banana', 'cherry'], 'pineapple')
/**
...
addFruitToFront(['apple', 'banana', 'cherry'], 'coconut')
...
removeLast(['apple', 'banana', 'cherry', 'coconut'])
...
removeLastandReturnLast(['apple', 'banana', 'cherry', 'tomato'])
